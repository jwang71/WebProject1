	...
	private Connection conn = null;
	  ...
	  public JSONArray GetRestaurantsNearLoation(double lat, double lon) {
		  	 try {
		  		 ...
		  		 String sql = "SELECT business_id, name, address, categories, stars, latitude, longitude, city, state from RESTAURANTS LIMIT 10";
		  		 ...
		  		 while (rs.next()) {
		  			 ...
		  			 obj.append("address", rs.getString("address"));
		...
		public void SetVisitedRestaurants(String userId, List<String> businessIds) {
		  	 try {
		  		 ...
		  		 System.out.println("jiaqi error here : ++++++++++++++++++++++++++++");
		  		 System.out.println(e.getMessage());
		  	 }
		   }
		...
		private JSONObject getRestaurantsById(String businessId) {
		  	 try {
		  		 Statement stmt = conn.createStatement();
		  		 String sql = "SELECT business_id, name, address, categories, stars, latitude, longitude, city, state, image_url from "
